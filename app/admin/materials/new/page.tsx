    ...
    <div className="bg-slate-900 rounded-2xl border border-slate-800 overflow-hidden">
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            rows={5}
            placeholder="Tulis konten materi lengkap di sini. Bisa berupa teori, rumus, penjelasan konsep, dll."
...
export default function NewMaterialPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/admin/materials') // ← FIX: bukan /admin
      router.refresh()
    } catch (err: any) {
      ...
      <div className="flex items-center gap-3 border-b border-slate-800 pb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            <BookOpen className="text-blue-400" /> Buat Materi Baru
          </h1>
          <p className="text-slate-500 text-sm mt-0.5">Tambahkan modul pembelajaran baru ke database.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-slate-900 rounded-2xl border border-slate-800 p-6 space-y-5">
          ...
          <div className="grid grid-cols-[1fr_auto] gap-3">
            <div className="space-y-1.5">
              ...
              <Input required name="title" placeholder="Contoh: Aljabar Dasar"
        ...
        <div className="flex justify-end gap-3 pt-2 border-t border-slate-800">
          ...
          <Button type="submit" disabled={loading}
            className="bg-blue-600 hover:bg-blue-700 text-white min-w-[160px] shadow-lg shadow-blue-900/30">
            {loading
